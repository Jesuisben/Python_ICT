...
mydict = {'kim': ('김철수', 30, '남자', '마포구 공덕동'), 'park': ('박영희', 20, '여자', '동대문구 휘경동')}

print(mydict)

# xml의 속성에 추가할 사전 정보
attribDict = {'kim': ('01011112222', 'hello@naver.com'), 'park': ('01033334444', 'world@daum.net')}
